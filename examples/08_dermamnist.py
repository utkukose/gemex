...
08_dermamnist.py
================
GEMEX vs GradCAM vs GradCAM++ vs Saliency — DermaMNIST

Dataset
-------
  Name    : DermaMNIST
  Task    : skin lesion classification — HAM10000 (7 lesion types)
  Classes : 7
  Note    : RGB 28×28 — converted to greyscale for GEMEX. 7-class.
...
Usage
-----
  python 08_dermamnist.py
  python 08_dermamnist.py --theme light
  python 08_dermamnist.py --save-dir ./my_results
  python 08_dermamnist.py --n-images 7 --epochs 20 --backend cnn
"""
...
MEDMNIST_DATASETS = {
    'derma': {
        ...
        'channels': 3,
        'task'    : 'skin lesion classification (HAM10000)',
    },
}
# ═══════════════════════════════════════════════════════════════════════
# DATA LOADING
...
# ═══════════════════════════════════════════════════════════════════════
# ENTRY POINT — DermaMNIST
# ═══════════════════════════════════════════════════════════════════════

if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(
        description='GEMEX vs GradCAM — DermaMNIST')
    parser.add_argument('--save-dir', default='./derma_results',
                        help='Output directory (default: ./derma_results)')
    parser.add_argument('--n-images', type=int, default=7,
                        help='Number of images to explain (default: 7)')
    ...
    print("  Dataset  : DermaMNIST")
    print("  Task     : skin lesion classification — HAM10000 (7 lesion types)")
    print("="*62)

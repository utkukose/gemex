...
07_pathmnist.py
===============
GEMEX vs GradCAM vs GradCAM++ vs Saliency — PathMNIST

Dataset
-------
  Name    : PathMNIST
  Task    : colorectal cancer tissue classification (9 tissue types)
  Classes : 9
  Note    : RGB 28×28 — converted to greyscale for GEMEX. 9-class.
...
Usage
-----
  python 07_pathmnist.py
  python 07_pathmnist.py --theme light
  python 07_pathmnist.py --save-dir ./my_results
  python 07_pathmnist.py --n-images 9 --epochs 20 --backend cnn
"""
...
MEDMNIST_DATASETS = {
    'path': {
        ...
        'classes' : ['Adipose','Background','Debris','Lymphocytes',
                     'Mucus','Smooth Muscle','Normal Mucosa',
                     'Stroma','Adenocarcinoma'],
        'channels': 3,
        'task'    : 'colorectal cancer tissue classification',
    },
}
# ═══════════════════════════════════════════════════════════════════════
# DATA LOADING
...
# ═══════════════════════════════════════════════════════════════════════
# ENTRY POINT — PathMNIST
# ═══════════════════════════════════════════════════════════════════════

if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(
        description='GEMEX vs GradCAM — PathMNIST')
    parser.add_argument('--save-dir', default='./path_results',
                        help='Output directory (default: ./path_results)')
    parser.add_argument('--n-images', type=int, default=9,
                        help='Number of images to explain (default: 9)')
    ...
    print("  Task     : colorectal cancer tissue classification (9 tissue types)")
    print("="*62)

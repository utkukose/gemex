...
"""
06_pneumoniamnist.py
====================
GEMEX vs GradCAM vs GradCAM++ vs Saliency — PneumoniaMNIST

Dataset
-------
  Name    : PneumoniaMNIST
  Task    : chest X-ray pneumonia detection (binary: Normal vs Pneumonia)
  Classes : 2
  Note    : Greyscale 28×28. Strong baseline — start here.
...
Usage
-----
  python 06_pneumoniamnist.py
  python 06_pneumoniamnist.py --theme light
  python 06_pneumoniamnist.py --save-dir ./my_results
  python 06_pneumoniamnist.py --n-images 2 --epochs 20 --backend cnn
"""
...
# ═══════════════════════════════════════════════════════════════════════
# ENTRY POINT — PneumoniaMNIST
# ═══════════════════════════════════════════════════════════════════════

if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(
        description='GEMEX vs GradCAM — PneumoniaMNIST')
    parser.add_argument('--save-dir', default='./pneumonia_results',
                        help='Output directory (default: ./pneumonia_results)')
    parser.add_argument('--n-images', type=int, default=2,
                        help='Number of images to explain (default: 2)')
    ...
    print("\n" + "="*62)
    print(f"  GEMEX vs GradCAM vs GradCAM++ vs Saliency")
    print(f"  Dataset  : PneumoniaMNIST")
    print(f"  Task     : chest X-ray pneumonia detection (binary: Normal vs Pneumonia)")
    print("="*62)
